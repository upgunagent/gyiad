                    ...
                    <div className="bg-white mx-6 rounded-2xl shadow-sm border border-gray-100 overflow-hidden relative">
                        ...
                        <div className="px-8 pb-8 flex flex-col md:flex-row gap-8 relative mt-[-64px]">
                            ...
                            <div className="flex-shrink-0">
                                <div className="w-72 h-72 rounded-full border-4 border-white shadow-lg relative bg-white">
                                    <Image
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="flex flex-col gap-2">
                                        {member.websites && member.websites.map((site: string, i: number) => (
                                        ...
                                        <a href={`mailto:${member.email}`} className="flex items-center gap-2 text-gray-700 hover:text-[#0099CC] text-sm font-medium transition-colors">
                                ...
                                <div className="lg:border-l lg:border-gray-200 lg:pl-6">
                                    ...
                                    <div className="font-semibold text-gray-700 text-sm space-y-1">
                                        {(!member.board_roles || member.board_roles.length === 0) ? (
                                            ...
                                            member.board_roles.map((role: any) => {
                                                const label = {
